export default function CTAFORWHATSAPP() {
  return (
    <div id="diversify" className="relative isolate bg-gray-900 ">
      ...
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 py-24 ">
        <div className="relative isolate overflow-hidden bg-gray-900 drop-shadow-sm shadow-white mx-4 rounded-2xl px-6 py-24 text-center shadow-lg border-t border-white sm:rounded-3xl sm:px-16">
